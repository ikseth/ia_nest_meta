...
| Ente | `ia_nest_core` | El motor: enruta, infiere, itera | - | - | `v0.2.0` | linea v0.3 en curso |
| Ente | `ia_nest_extended` [1] | La memoria/conocimiento | enriquecimiento (`core ADR 0031`) | `core >=0.2 <0.3` | ninguna (sin tag) | memoria F2-F4 verificada; F5 (RAG) en curso |
